...
#define SPI1_INK_GPIO_Port GPIOA

#define EPD_W21_MOSI_0	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_MOSI_Pin, GPIO_PIN_RESET)
#define EPD_W21_MOSI_1	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_MOSI_Pin, GPIO_PIN_SET)

#define EPD_W21_CLK_0	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_SCK_Pin, GPIO_PIN_RESET)
#define EPD_W21_CLK_1	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_SCK_Pin, GPIO_PIN_SET)

#define EPD_W21_CS_0	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_RESET)
#define EPD_W21_CS_1	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_SET)

#define EPD_W21_DC_0	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, DC_INKS_Pin, GPIO_PIN_RESET)
#define EPD_W21_DC_1	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, DC_INKS_Pin, GPIO_PIN_SET)

#define EPD_W21_RST_0	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, RES_INKS_Pin, GPIO_PIN_RESET)
#define EPD_W21_RST_1	HAL_GPIO_WritePin(SPI1_INK_GPIO_Port, RES_INKS_Pin, GPIO_PIN_SET)

#define EPD_W21_BUSY_LEVEL 0
#define isEPD_W21_BUSY HAL_GPIO_ReadPin(SPI1_INK_GPIO_Port, BUSY_INKS_Pin)
...
const unsigned char LUTDefault_full[31] = {
 0x32,	// command
 0x66,  // machine LUT
 0x66,0x44,0x66,0xAA,0x11,0x80,0x08,0x11,0x18,0x81,0x18,0x11,0x88,0x11,0x88,
...
void inkscreen_dis_full(unsigned char *disBuffer,unsigned char label)
{
    EPD_W21_SetRamPointer(0x00,(yDot-1)%256,(yDot-1)/256);	// set ram
	if(label==0)
	{
...
void inkscreen_dis_part(unsigned char xStart,unsigned char xEnd,unsigned long yStart,unsigned long yEnd,unsigned char *disBuffer,unsigned char label)
{
	if(label==0)
	{
...
void inkscreen_int(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = RES_INKS_Pin | DC_INKS_Pin | SPI1_CS_Pin |\
                                SPI1_SCK_Pin | SPI1_MOSI_Pin;    //abcd OE ST LT0输出
  GPIO_InitStructure.GPIO_Speed = GPIO_SPEED_FREQ_MEDIUM;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(SPI1_INK_GPIO_Port, &GPIO_InitStructure);

  GPIO_InitStructure.GPIO_Pin = BUSY_INKS_Pin;    //abcd OE ST LT0输出
  GPIO_InitStructure.GPIO_Speed = GPIO_SPEED_FREQ_MEDIUM;
